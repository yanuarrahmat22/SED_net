    ...
    <div class="container py-5">
        ...
        <div class="row py-4">
            <div class="    mx-auto">
                ...
                <!-- Uploaded image area-->
                <div class="mb-3">
                    <p class="font-italic text-white text-center">The prediction image will be rendered inside the box below.</p>
                    <div class="image-area mt-4"><img id="imageResult" src="{% static 'img/predictimg.jpg' %}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                </div>
